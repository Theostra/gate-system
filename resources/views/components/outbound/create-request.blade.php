...
new class extends Component
{
    ...
    public $item_photo;
    public $items = [['name' => '', 'qty' => '', 'unit' => 'Pcs']]; 
    ...
    public function submit()
    {
        ...
        $manifestPath = $this->manifest_document ? $this->manifest_document->store('manifests_outbound', 'public') : null;
        $vehiclePhotoPath = $this->vehicle_photo ? $this->vehicle_photo->store('outbound_photos', 'public') : null;
        $itemPhotoPath = $this->item_photo ? $this->item_photo->store('outbound_photos', 'public') : null;
        ...
        if ($this->requestId) {
            ...
            session()->flash('message', 'Revisi pengajuan OUTBOUND berhasil dikirim.');
        } else {
            ...
            session()->flash('message', 'Pengajuan OUTBOUND (Barang Keluar) berhasil dikirim.');
        }
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">
                {{ $requestId ? 'Revisi Pengajuan Barang Keluar (Outbound)' : 'Form Pengajuan Barang Keluar (Outbound)' }}
            </h2>
            
            <form wire:submit.prevent="submit" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <x-input-label for="company_name" :value="__('Nama Perusahaan/Divisi')" />
                    ...
                    <div>
                        ...
                        <x-text-input wire:model="company_address" id="company_address" class="block mt-1 w-full" type="text" required autofocus />
                    ...
                    <div>
                        <x-input-label for="driver_name" :value="__('Nama PIC (Pembawa)')" />
                    ...
                    <div>
                        <x-input-label for="scheduled_date" :value="__('Tanggal Keluar Barang')" />
                ...
                <div>
                    ...
                    <x-text-input wire:model="purpose" id="purpose" class="block mt-1 w-full" type="text" placeholder="Contoh: Pemindahan Material Bekas" required />
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                    <x-input-label for="manifest_document" :value="__('Dokumen Surat Jalan / Form Pengeluaran (Opsional, PDF/JPG)')" />
